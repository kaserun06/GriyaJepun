...
<tbody>
<?php 
    $sql = "select * from tbl_pelanggan where flag = 1";
...
<tr>
    ...
    <?php
        ...
        echo "<a href='proses_admin/deleteTamu.php?id=$id_tamu' class='btn btn-danger'>Delete</a>";
    ?>
    </td>
</tr>
...
<div class="modal fade" id="myModal<?php echo $data['id_tamu']; ?>" role="dialog">
    ...
    <div class="modal-content">
        ...
        <form role="form" action="proses_admin/prosesUpdateTamu.php" method="get">

        <?php
        $id = $data['id_tamu']; 
        $sql2 = "SELECT * FROM tbl_pelanggan WHERE id_tamu='$id'";
