...
<tr>
    ...
    <?php
        $nip = $data["nip"];
        echo "<a href='proses_admin/deleteKaryawan.php?id=$nip' class='btn btn-danger'>Delete</a>";
    ?>
    </td>
</tr>
...
<div class="modal fade" id="myModal<?php echo $data['nip']; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <form role="form" action="proses_admin/updateKaryawan.php" method="get">
        <?php
        $id = $data['nip']; 
        $sql2 = "SELECT * FROM tbl_admin WHERE nip='$id'";
