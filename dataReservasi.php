...
<?php 
    ...
    and tbl_fasilitas.id_fasilitas = tbl_reservasi.id_fasilitas and tbl_reservasi.flag = 1";
...
<tr>
    ...
    <?php
        ...
        echo "<a href='proses_admin/deleteReservasi.php?id=$id_reservasi' class='btn btn-danger'>Hapus</a>";
    ?>
    </td>
</tr>
...
<div class="modal fade" id="myModal<?php echo $data['id_reservasi']; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <form role="form" action="proses_admin/updateReservasi.php" method="post">
        ...
        $sql2 = "select id_reservasi, nama_tamu, nama_kamar, fasilitas, tanggal_check_in, tanggal_check_out, lama_inap, total_biaya
                from tbl_kos, tbl_fasilitas, tbl_reservasi
                where  tbl_kos.kode_kamar = tbl_reservasi.kode_kamar
                and tbl_fasilitas.id_fasilitas = tbl_reservasi.id_fasilitas and id_reservasi='$id'";
